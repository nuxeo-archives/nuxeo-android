...
public class AndroidWidgetMapper {
    ...
    public static void registerWidgetWrapper(String type,
            Class<? extends AndroidWidgetWrapper> wrapperClass) {
        ...
        try {
            ...
            if (type == null) {
                Log.w(this.getClass().getSimpleName(),
                        "No Widget mapping found for type " + wDef.getType()
                                + " with name " + wDef.getName());
                return null;
            }
