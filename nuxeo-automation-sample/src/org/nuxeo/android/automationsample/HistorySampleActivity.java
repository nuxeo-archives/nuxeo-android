...
public class HistorySampleActivity extends BaseNuxeoActivity {
	...
	protected void onNuxeoDataRetrieved(Object data) {
        ...
        try {
            ...
            Log.e(this.getClass().getSimpleName(),"Unable to read the audit entries",e);
        }
	...
	protected Object retrieveNuxeoData() throws Exception {
		return getNuxeoSession().getAdapter(DocumentManager.class).getAuditEntriesForDocument(getCurrentDocument().getId(), false);
	}
