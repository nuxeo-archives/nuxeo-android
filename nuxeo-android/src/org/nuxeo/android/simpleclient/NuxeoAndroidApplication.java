 ...
 * @since 2011.02.17
 */
public final class NuxeoAndroidApplication
    extends SmartApplication
{

  public static class CacheInstructions
      extends AdvancedImageDownloader.AdvancedAbstractInstructions
  {

    @Override
    public InputStream getInputStream(String imageUid, Object imageSpecs, String url, ImageDownloader.InputStreamDownloadInstructor downloadInstructor)
        throws IOException
    {
  ...
  {
    return new SmartApplication.I18N(getText(R.string.problem), getText(R.string.unavailableItem), getText(R.string.unavailableService), getText(R.string.connectivityProblem), getText(R.string.unhandledProblem));
  }

  @Override
  protected SmartApplication.I18NExt getI18NExt()
  {
    return new SmartApplication.I18NExt(getString(R.string.applicationName), getText(R.string.dialogButton_unhandledProblem), getString(R.string.progressDialogMessage_unhandledProblem));
  }
    ...
    return new ActivityController.Redirector()
    {
      public Intent getRedirection(Activity activity)
      {
        if (NuxeoAndroidSplashScreenActivity.isInitialized(NuxeoAndroidSplashScreenActivity.class) == false)
        {
          ...
          if (activity.getComponentName() == null || activity.getComponentName().getClassName().equals(NuxeoAndroidSplashScreenActivity.class.getName()) == true)
          {
            return null;
          }
          else
          {
            return new Intent(activity, NuxeoAndroidSplashScreenActivity.class);
          }
        }
        return null;
      }
